...
class UserDetail {
  ...
  factory UserDetail.fromMap(Map<String, dynamic> data) => UserDetail(
        id: data['id'] as int?,
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [UserDetail].
  factory UserDetail.fromJson(String data) {
    return UserDetail.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [UserDetail] to a JSON string.
